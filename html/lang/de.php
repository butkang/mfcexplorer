...
function lang($phrase){
    static $lang = array(
		...
		'POS_MFC' => 'PoS Stake [MFC]',
		'POS_POS' => 'PoS',
		'POW_POW' => 'PoW',
		'REWARD_MFC' => 'Belohnung [MFC]',
		'SEARCH_SEARCH' => 'Suche',
		...
		'TX_VOLUME_MFC' => 'TX Volumen [MFC]',
		'TX_FEE_MFC' => 'TX Gebühr [MFC]',
		...
		'POW_MINTED' => 'PoW/PoS MFC Erzeugt',
		...
		'BALANCE_MFC' => 'Guthaben [MFC]',
		'HOLDINGS_MFC' => 'Besitz [MFC]',
		...
		'THIS_BALANCE2' => 'MFC von deinem Guthaben abbuchen.',
		'TRANSACTION_MFC' => 'Transaktionsgebühr:',
		'USERNAME_USERNAME' => 'Benutzername',
		'VALID_EXTERNAL' => 'gültig (extern)',
		'VALID_INTERNAL' => 'gültig (intern)',
		'VOLUME_VOLUME' => 'Volumen',
		'MFCSSL_VERYHIGH' => 'EMCSSL mit deinem Passwort [Sehr hohe Sicherheit]',
		'MFCSSL_HIGH' => 'EMCSSL ohne Passwort [Hohe Sicherheit]',
		'MFCSSL_LOW' => 'EMCSSL ODER Passwort [Geringe Sicherheit]',
		'MFCSSL_DEACTIVATE' => 'Deaktiviere EMCSSL',
		'YOUR_CERTIFICATE' => 'Dein MFCSSL Zertifikat',
		'YOU_LOGIN' => 'Du kannst MFCSSL nutzen um deinen Login abzusichern.',
		'WHAT_MFCSSL' => 'Was ist EMCSSL?',
		...
		'THIS_SUBSTRACTBALANCE' => 'Diese Transaktion wird "+(parseFloat(amount)+parseFloat(fee))+" MFC von deinem Guthaben abbuchen.',
		'THIS_SUBSTRACTBALANCE2' => 'Diese Transaktion wird "+amount+" MFC von deinem Guthaben abbuchen.',
		'TRANSACTION_QUEUE' => 'Die Transaktion wurde der Warteschlange hinzugefügt.',
		'MFC_TO' => 'EMC wurden übertragen an',
		...
		'MFCSSL_SET' => 'EMCSSL wurde gesetzt"',
