...
function lang($phrase){
 ...
 'CHAIN_COIN' => '块链币龄销毁 [天/币]',
                ...
                'YOUR_CERTIFICATE' => '您的BUTKSSL证书',
                'YOU_LOGIN' => '您可以使用BUTKSSL来保证您的登陆安全。',
                ...
                'STOCK_BTC' => '市场价 - BUTK/BTC',
                'STOCK_USD' => '市场价 - BUTK/USD',
                'STAKE_PERIOD' => '本时段利息',
                'EARNED_STAKE' => '利息收入',
                'AVERAGE_AT' => '均价',
                'VWAP_VWAP' => '成交量加权均价',
                ...
                'SEND_COINS' => '发送BUTK',
                'THIS_SUBSTRACTBALANCE' => '该笔交易将从您的余额中消耗"+ (parseFloat(amount)+parseFloat(fee)) +"BUTK。',
                'THIS_SUBSTRACTBALANCE2' => '该笔交易将从您的余额中消耗 "+amount+" BUTK。',
