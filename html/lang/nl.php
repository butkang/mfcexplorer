...
function lang($phrase){
    static $lang = array(
		...
		'COIN_MFC' => 'Munten beschikbaar [MFC]',
		'DAYS_DAYS' => 'Dagen',
		...
		'POS_MFC' => 'PoS-aandeel [MFC]',
		'POS_POS' => 'PoS',
		'POW_POW' => 'PoW',
		'REWARD_MFC' => 'Beloning [MFC]',
		'SEARCH_SEARCH' => 'Zoek',
		...
		'TX_VOLUME_MFC' => 'TX-volume [MFC]',
		'TX_FEE_MFC' => 'TX-kosten [MFC]',
		...
		'POW_MINTED' => 'PoW/PoS MFC gevonden',
		...
		'BALANCE_MFC' => 'Saldo [MFC]',
		'HOLDINGS_MFC' => 'Bezit [MFC]',
		...
		'THIS_BALANCE2' => 'MFC van je saldo.',
		'TRANSACTION_MFC' => 'Transactiekosten:',
		'USERNAME_USERNAME' => 'Gebruikersnaam',
		'VALID_EXTERNAL' => 'geldig (extern)',
		'VALID_INTERNAL' => 'geldig (intern)',
		'VOLUME_VOLUME' => 'Volume',
		'MFCSSL_VERYHIGH' => 'Gebruik EMCSSL met huidige wachtwoord [zeer hoge veiligheid]',
		'MFCSSL_HIGH' => 'EMCSSL zonder wachtwoord [hoge veiligheid]',
		'MFCSSL_LOW' => 'EMCSSL of wachtwoord [lage veiligheid]',
		'MFCSSL_DEACTIVATE' => 'Deactiveer EMCSSL',
		'YOUR_CERTIFICATE' => 'Jouw MFCSSL-certificaat',
		'YOU_LOGIN' => 'Je kan MFCSSL gebruiken om je login te beveiligen.',
		'WHAT_MFCSSL' => 'Wat is EMCSSL?',
		...
		'STOCK_BTC' => 'Börse - MFC/BTC',
		'STOCK_USD' => 'Börse - MFC/USD',
		...
		'THIS_SUBSTRACTBALANCE' => 'Deze transactie zal van je saldo "+(parseFloat(amount)+parseFloat(fee))+" MFC in mindering brengen van je saldo.',
		'THIS_SUBSTRACTBALANCE2' => 'Deze transactie zal van je saldo "+amount+" MFC in mindering brengen.',
		'TRANSACTION_QUEUE' => 'Deze transactie wordt toegevoegd aan de wachtrij.',
		'MFC_TO' => 'EMC is overgemaant aan',
...
Je kan het registratieadres aanpassen naar een van je huidige adressen of elk ander adres op een later tijdstip.',
		...
		'MFCSSL_SET' => 'EMCSSL-instellingen zijn opgeslagen',
