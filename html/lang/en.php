...
function lang($phrase){
    static $lang = array(
		...
		'BALANCE_MFC' => 'Balance [MFC]',
		'HOLDINGS_MFC' => 'Holdings [MFC]',
		...
		'THIS_BALANCE2' => 'MFC from your balance.',
		'TRANSACTION_MFC' => 'Transaction fee:',
		'USERNAME_USERNAME' => 'Username',
		'VALID_EXTERNAL' => 'valid (external)',
		'VALID_INTERNAL' => 'valid (internal)',
		'VOLUME_VOLUME' => 'Volume',
		'MFCSSL_VERYHIGH' => 'Use EMCSSL with current password [Very High Security]',
		'MFCSSL_HIGH' => 'Use EMCSSL only [High Security]',
		'MFCSSL_LOW' => 'Use EMCSSL or password [Low Security]',
		'MFCSSL_DEACTIVATE' => 'Deactivate EMCSSL',
		'YOUR_CERTIFICATE' => 'Your MFCSSL certificate',
		'YOU_LOGIN' => 'You can use MFCSSL to secure your login.',
		'WHAT_MFCSSL' => 'What is EMCSSL?',
		'MFCSSL_SET' => 'EMCSSL settings saved',
		...
		'STOCK_BTC' => 'Stock Ex. - MFC/BTC',
		'STOCK_USD' => 'Stock Ex. - MFC/USD',
		...
		'THIS_SUBSTRACTBALANCE' => 'This transaction will subtract "+(parseFloat(amount)+parseFloat(fee))+" MFC from your balance.',
		'THIS_SUBSTRACTBALANCE2' => 'This transaction will subtract "+amount+" MFC from your balance.',
		'TRANSACTION_QUEUE' => 'Transaction has been added to the queue.',
		'MFC_TO' => 'EMC have been transferred to',
