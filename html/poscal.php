...
<div class="container">
	<h2>Proof-of-Stake</h2>
	  ...
	  <div class="row">
		...
		<div class="col-sm-8">
	    	<table class="table">
						<tr><th colspan="2"><?php echo lang("MINTING_CHANCE");?></th><th><?php echo lang("ESTIMATED_REWARD");?> [MFC]</th><tr>
	  ...
	  <hr>
		<h2>Proof-of-Work - Merged Mining - MFC/BTC </h2>
		<div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	  ...
	  <div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	      MFC PoW Difficulty <input type="input" class="form-control" id="inputPoWDiff" placeholder="EMC PoW-Difficulty" value="<?php echo $powDifficulty; ?>">
	    </div>
	  </div>
	  <div class="row">
	    <div class="col-sm-offset-2 col-sm-8">
	  ...
	  <div class="row">
		...
		<div class="col-sm-8">
	    	<table class="table">
					<tr><th>Avg. time to find a MFC block</th><th>Est. reward per day [MFC]</th><th>PoW Block Reward [EMC]</th><tr>
