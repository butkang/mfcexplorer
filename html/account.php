...
<table class="table">
	<tr><td><h3>Balance</h3></td><td width="75%"><h3><span class="label label-success">'.TrimTrailingZeroes(number_format($balance,8)).' MFC</span></h3></td></tr>';
foreach ($addressbalances as $key => $value) {
	if ($value>0) {echo '<tr><td>'.$key.'</td><td>'.$value." MFC</td></tr>";}
}
echo '</table>';
