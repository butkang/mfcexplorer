	...
	if (isset($received_count)) {
		 ...
		 if (strpos(file_get_contents("blacklist.txt"), $address) !== false) {
			...
			echo '<div class="panel-heading">
				...
				<div class="panel-body">
					...
					<tr><td>'.lang("RECEIVED_RECEIVED").'</td><td><span class="label label-success">'.TrimTrailingZeroes(number_format($received_count,0)).' '.lang("OUTPUTS_OUTPUTS").' / '.TrimTrailingZeroes(number_format($received_total,8)).' MFC</span></td></tr>
					</table>
				</div>
				</div>';
		...
		echo '<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<tr><td>'.lang("RECEIVED_RECEIVED").'</td><td><span class="label label-success">0 '.lang("OUTPUTS_OUTPUTS").' / 0 MFC</span></td></tr>
					</table>
				</div>
				</div>';
